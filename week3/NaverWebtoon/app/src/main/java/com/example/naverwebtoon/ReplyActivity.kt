...
class ReplyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reply.add(ReplyInfo("전현택","2021-04-03 23:13","중간에 \"반 티값은 니가 잘 관리했어야지,,\" 이거 어케 알았냐? 잃어버렸다 했지 뭘 잃어버렸다는지 얘기안했는데???",9826,112,false,false))
        reply.add(ReplyInfo("신경훈","2021-04-03 23:13","근데 오디오헤드 관심 1도 없다는걸 알게되면 되게 서운해할듯...",9826,112,false,false))
        reply.add(ReplyInfo("전현택","2021-04-03 23:13","중간에 \"반 티값은 니가 잘 관리했어야지,,\" 이거 어케 알았냐? 잃어버렸다 했지 뭘 잃어버렸다는지 얘기안했는데???",9826,112,false,false))
        reply.add(ReplyInfo("정쥰","2021-04-03 23:13","이지아가 훔친 반티값으로 타겟팅한거 같음 그래서 가방이나 사물함같은데선 나올리가 없지..",9826,112,false,false))
        reply.add(ReplyInfo("전현택","2021-04-03 23:13","중간에 \"반 티값은 니가 잘 관리했어야지,,\" 이거 어케 알았냐? 잃어버렸다 했지 뭘 잃어버렸다는지 얘기안했는데???",9826,112,false,false))
        reply.add(ReplyInfo("정쥰","2021-04-03 23:13","이지아가 훔친 반티값으로 타겟팅한거 같음 그래서 가방이나 사물함같은데선 나올리가 없지..",9826,112,false,false))
        reply.add(ReplyInfo("신경훈","2021-04-03 23:13","근데 오디오헤드 관심 1도 없다는걸 알게되면 되게 서운해할듯...",9826,112,false,false))
        reply.add(ReplyInfo("정쥰","2021-04-03 23:13","이지아가 훔친 반티값으로 타겟팅한거 같음 그래서 가방이나 사물함같은데선 나올리가 없지..",9826,112,false,false))
