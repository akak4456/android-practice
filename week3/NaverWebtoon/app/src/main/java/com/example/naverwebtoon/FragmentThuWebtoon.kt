...
class FragmentThuWebtoon(
    ...
    override fun onCreateView(
        ...
        val isUp = false
        for(i in 1..3){
            webtoonList.add(WebtoonInfo(R.drawable.thu_webtoon_1,getString(R.string.thu_webtoon_1_title),getString(R.string.thu_webtoon_1_author),"★ "+String.format("%.2f", Random.nextInt(700,1000)/100.0f),isUp))
            webtoonList.add(WebtoonInfo(R.drawable.thu_webtoon_2,getString(R.string.thu_webtoon_2_title),getString(R.string.thu_webtoon_2_author),"★ "+String.format("%.2f", Random.nextInt(700,1000)/100.0f),isUp))
            webtoonList.add(WebtoonInfo(R.drawable.thu_webtoon_3,getString(R.string.thu_webtoon_3_title),getString(R.string.thu_webtoon_3_author),"★ "+String.format("%.2f", Random.nextInt(700,1000)/100.0f),isUp))
            webtoonList.add(WebtoonInfo(R.drawable.thu_webtoon_4,getString(R.string.thu_webtoon_4_title),getString(R.string.thu_webtoon_4_author),"★ "+String.format("%.2f", Random.nextInt(700,1000)/100.0f),isUp))
            webtoonList.add(WebtoonInfo(R.drawable.thu_webtoon_5,getString(R.string.thu_webtoon_5_title),getString(R.string.thu_webtoon_5_author),"★ "+String.format("%.2f", Random.nextInt(700,1000)/100.0f),isUp))
        }
